...
/**
 * Single attempt — throws Error with `.status` and `.body` (parsed JSON) on failure.
 */
 ...
 * Retries idempotent GET once after ~2s on INTERNAL_ERROR or 5xx (transient upstream / document pipeline).
 * @param {string} path - e.g. `/case/DLHC010001232024` or `/search`
 * @param {{ method?: 'GET'|'POST', params?: Record<string, unknown>, body?: unknown }} opts
 */
